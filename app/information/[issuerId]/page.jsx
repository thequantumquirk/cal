...
export default function IssuerRecordsPage() {
  ...
  // ⚡ OPTIMIZED: SWR for documents with PARALLEL fetching
  ...
  const publicDocuments = docsData?.documents || []
  ...
  const isLoading = issuerLoading || docsLoading || notesLoading || !securitiesData
