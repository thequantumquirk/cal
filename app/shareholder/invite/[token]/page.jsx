...
export default function ShareholderInvitePage() {
    ...
    try {
      ...
      const { data, error: fetchError } = await supabase
        ...
        .select(`
          ...
          issuers_new:issuer_id (issuer_name)
        `)
        .eq("id", token)
        .maybeSingle();
      ...
      if (data.roles_new?.role_name !== "Shareholder") {
        setError("This invitation is not valid for shareholder access.");
        return;
      }
  ...
  const handleSignUp = async (e) => {
    ...
    try {
      ...
      router.push("/shareholder/onboarding");
            ...
            <div className="space-y-6">
              <div className="text-center space-y-2">
                ...
                <p className="text-muted-foreground">
                  {invitation?.issuers_new?.issuer_name
                    ? `Set up your shareholder account for ${invitation.issuers_new.issuer_name}`
                    : "Set up your shareholder account to get started"
                  }
                </p>
              </div>
