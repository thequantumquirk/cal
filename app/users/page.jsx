...
import ManageShareholdersSection from "@/components/manage-shareholders-section"
          ...
          <div className="py-8">
            <div className="max-w-7xl mx-auto px-6">
              ...
              */}
              ...
              {/* Manage Shareholders Section - Only visible to superadmins */}
              {userRole === "superadmin" && (
                <ManageShareholdersSection />
              )}
            </div>
          </div>
        </main>
