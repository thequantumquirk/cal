      ...
      <Card className="card-glass border-0">
        ...
        <CardContent>
          <Table>
            <TableHeader>
              <TableRow>
                <TableHead className="font-bold text-gray-700">Investor Type</TableHead>
                <TableHead className="font-bold text-gray-700 text-right">Ownership</TableHead>
              </TableRow>
            </TableHeader>
            <TableBody>
              <TableRow className="hover:bg-white/30">
                <TableCell className="font-medium text-gray-900">Institutional</TableCell>
                <TableCell className="text-right font-semibold">{data.institutional.toFixed(1)}%</TableCell>
              </TableRow>
              <TableRow className="hover:bg-white/30">
                <TableCell className="font-medium text-gray-900">Retail / Non-13F</TableCell>
                <TableCell className="text-right font-semibold">{data.retail.toFixed(1)}%</TableCell>
              </TableRow>
              <TableRow className="hover:bg-white/30">
                <TableCell className="font-medium text-gray-900">Insider</TableCell>
