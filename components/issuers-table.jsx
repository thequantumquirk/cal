...
import { Building, Plus, Edit, Users, Search, MoreHorizontal, Eye, Trash2, Shield, RefreshCw, AlertTriangle, X } from "lucide-react"
        ...
        <div className="rounded-md border border-border overflow-hidden shadow-sm bg-background">
          ...
          {filteredIssuers.length === 0 && (
            <div className="px-8 py-16 text-center">
              ...
              <h3 className="text-xl font-semibold text-foreground mb-3">No issuers found</h3>
              ...
              {!searchTerm && (
                <Button
                  onClick={handleCreate}
                  className="bg-wealth-gradient text-black font-bold hover:opacity-90 border-0 shadow-md mb-4"
                >
                  <Plus className="h-4 w-4 mr-2" />
                  Create First Issuer
                </Button>
