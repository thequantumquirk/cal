...
function ShareholdersTable({
  ...
  const filteredShareholders = shareholders.filter((shareholder) => {
    const fullName = getShareholderName(shareholder).toLowerCase();
              ...
              {paginatedShareholders.map((shareholder) => (
                ...
                >
                  <TableCell className="font-medium text-gray-900">
                    {getShareholderName(shareholder)}
                  </TableCell>
                  ...
                  <TableCell className="font-medium text-gray-900 text-right">
                    {shareholder.current_shares
                      ? shareholder.current_shares.toLocaleString()
                      : "0"}
                  </TableCell>
                  <TableCell className="font-medium text-gray-900">
  ...
  variant="outline"
  size="sm"
  onClick={() => router.push(`/issuer/${issuerId}/shareholder/${shareholder.id}`)}
