        ...
        <div className="px-6 py-4 border-b border-border">
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h3 className="text-lg font-semibold text-foreground">Super Administrators</h3>
                <p className="text-sm text-muted-foreground">Manage system super administrators</p>
              </div>
            </div>
            <Button
