    ...
    <div className="max-w-4xl mx-auto">
      ...
      <div className="mb-8">
        <div className="flex items-center justify-between">
          {[1, 2, 3].map((s) => (
            <div key={s} className="flex-1 flex items-center">
              <div className={`flex items-center justify-center w-10 h-10 rounded-full ${step >= s ? 'bg-primary text-primary-foreground' : 'bg-muted text-muted-foreground'
                }`}>
        ...
        <div className="flex justify-between mt-2 text-sm">
          <span className={step >= 1 ? 'text-primary font-medium' : 'text-muted-foreground'}>Request Type</span>
          <span className={step >= 2 ? 'text-primary font-medium' : 'text-muted-foreground'}>Details</span>
          <span className={step >= 3 ? 'text-primary font-medium' : 'text-muted-foreground'}>Documents</span>
        </div>
      </div>
          ...
          {step === 2 && (
            <div className="space-y-6">
              ...
              <div className="flex justify-between">
                ...
                <Button onClick={handleNext} disabled={!selectedShareholder || !selectedCusip}>
                  Next Step <ArrowRight className="w-4 h-4 ml-2" />
                </Button>
              </div>
            </div>
            ...
            <div className="space-y-6">
              ...
              <div className="flex justify-between">
                ...
                <Button
                  ...
                  className="bg-wealth-gradient hover:opacity-90"
                >
