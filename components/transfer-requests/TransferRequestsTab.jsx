  ...
  return (
    <div>
      ...
      <div className="mb-6 flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4">
        <div>
          <h3 className="text-2xl font-semibold text-gray-900">Transfer Agent Requests</h3>
          <p className="text-sm text-gray-600">Submit and track transfer agent requests</p>
        </div>
        {isBroker && (
          <Button onClick={handleNewRequest} className="bg-gradient-to-r from-orange-500 to-red-500 hover:from-orange-600 hover:to-red-600">
      ...
      {loading ? (
        ...
        <div className="text-center py-12">
          ...
          {isBroker && requests.length === 0 && (
            <Button onClick={handleNewRequest} className="bg-gradient-to-r from-orange-500 to-red-500">
              <Plus className="w-4 h-4 mr-2" />
