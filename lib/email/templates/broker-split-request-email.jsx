...
export default function BrokerSplitRequestEmail({
    ...
    viewRequestUrl = '#',
    // Logo URL
    logoUrl = 'https://app.efficiencyta.com/final.png',
}) {
    // Brand colors
        ...
        <Html>
            ...
            <Body style={main}>
                <Container style={container}>
                    {/* Header with Logo - TODO: Implement later */}
                    ...
                    <Section style={{ ...headerSection, background: `linear-gradient(135deg, ${brandTeal} 0%, #0e7490 100%)` }}>
                        <Heading style={heading}>Broker Split Request</Heading>
                        <Text style={headerSubtext}>Action Required</Text>
                    </Section>
                    ...
                    <Section style={sectionContainer}>
                        ...
                        <table style={table}>
                            <tbody>
                                ...
                                {brokerAccountAtDtc && (
                                    <tr>
                                        <td style={labelCell}>Broker Account:</td>
                                        <td style={{ ...valueCell, fontFamily: 'monospace' }}>{brokerAccountAtDtc}</td>
                                    </tr>
                                )}
                                <tr>
                    ...
                    <Section style={reviewSection}>
                        <Text style={{ ...sectionHeading, textAlign: 'center', marginBottom: '8px', color: '#0891b2' }}>
                            STEP 1: REVIEW DOCUMENTS
                        </Text>
                        <Text style={{ textAlign: 'center', color: '#6b7280', fontSize: '14px', margin: '0 0 16px 0' }}>
                            Review the uploaded documents before approving or rejecting
                        </Text>
                        <Section style={{ textAlign: 'center' }}>
                            <Button
                                ...
                                href={viewRequestUrl}
                            >
                                Review Documents & Request Details
                            </Button>
                        </Section>
                    </Section>
                    ...
                    <Section style={actionSection}>
                        ...
                        <Text style={{ textAlign: 'center', color: '#6b7280', fontSize: '14px', margin: '0 0 24px 0' }}>
                            After reviewing the documents, approve or reject the request
                        </Text>
