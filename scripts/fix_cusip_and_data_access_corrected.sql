-- Comprehensive fix for CUSIP data access and RLS policies (CORRECTED)
-- This script ensures all data is properly accessible based on user roles and issuer access

-- Step 1: Fix securities table policies (this is the main table we use)
...
DROP POLICY IF EXISTS securities_read_all ON securities;
DROP POLICY IF EXISTS securities_admin_write ON securities;
...
-- Step 5: Create a simple function to get CUSIP data from securities table
